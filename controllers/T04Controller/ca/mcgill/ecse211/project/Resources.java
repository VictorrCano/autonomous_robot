...
/*
 * (non-Javadoc comment) TODO Integrate this carefully
 *  with your existing Resources class (See below for where to add
 * your code from your current Resources file). The order in which things are declared matters!
 */

/**
 * Class for static resources (things that stay the same throughout
 *  the entire program execution), like constants and
 * hardware. <br>
 * <br>
...
public class Resources {
  ...
  /**
   * The IP address of the server that sends data to the robot.
  ...
  /** Your team number. */
  public static final int TEAM_NUMBER = 04;
  ...
  // Robot constants
  /** Box width in meters. */
  public static final double BOX_WIDTH = 0.15;
  ...
  public static final double BASE_WIDTH = 0.153;

  /** The distance between the color sensors and the wheels in meters. */
  public static final double COLOR_SENSOR_TO_WHEEL_DIST = 0.03;
  ...
  public static final int ROTATE_SPEED = 240;

  /** Fast Rotate Speed. */
  public static final int FAST_ROTATE_SPEED = 500;
  ...
  /**
   * The number of tiles in the playing area in the
   * 
   * X (horizontal) direction.
   */
  public static final int NUMBER_OF_TILES_X = 15;

  /**
   * The number of tiles in the playing area in the Y (vertical) direction.
   */
  public static final int NUMBER_OF_TILES_Y = 9;

  /**
   * Correction for the robot to use when moving blocks to ensure it travels
   *  just short of the waypoint and not actually
   * at the waypoint.
   */
  public static final double CORRECTION = 0.1;

  /** Rad to degree constant. */
  public static final double RAD_TO_DEGREE = 180.0 / Math.PI;

  /** Degree to Rad constant. */
  public static final double DEGREE_TO_RAD = Math.PI / 180.0;
  ...
  /** Third color sensor for the front. */
  ...
  /** The torquemeter. */
  public static Torquemeter torquemeter = Torquemeter.getTorquemeter();

  /** Object Detection Thread. */
  public static ObjectDetection objectDetection = ObjectDetection.getObjectDetection();
  ...
  public static void receiveWifiParameters() {
    ...
    try (var conn = new WifiConnection(SERVER_IP, TEAM_NUMBER, ENABLE_DEBUG_WIFI_PRINT)) {
       ...
       *  in the GUI on their laptop with the
       * data filled in.
       */
